<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Pestañas
                                        <div class="page-title-subheading">Las pestañas se utilizan para dividir el contenido entre varias secciones.
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="main-card mb-3 card">
                                            <div class="card-header"><i class="header-icon fas fa-paperclip"></i>Cabecera con pestañas
                                                <div class="btn-actions-pane-right">
                                                    <div role="group" class="btn-group-sm nav btn-group">
                                                        <a data-toggle="tab" href="#tab-eg1-0" class="btn-shadow active btn btn-secondary">Tab 1</a>
                                                        <a data-toggle="tab" href="#tab-eg1-1" class="btn-shadow  btn btn-secondary">Tab 2</a>
                                                        <a data-toggle="tab" href="#tab-eg1-2" class="btn-shadow  btn btn-secondary">Tab 3</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="main-card mb-3 card">
                                            <div class="card-header"><i class="header-icon fas fa-home"></i>Cabecera con pestañas con botones
                                                <div class="btn-actions-pane-right">
                                                    <div class="nav">
                                        ...
                                        <div class="main-card mb-3 card">
                                            <div class="card-header"><i class="header-icon fas fa-arrow-right"></i> Alternativa de pestañas
                                                <div class="btn-actions-pane-right">
                                                    <div role="group" class="btn-group-sm nav btn-group">
                                        ...
                                        <div class="main-card mb-3 card">
                                            <div class="card-header"><i class="header-icon fas fa-award"></i> Cabecera estandar con pestañas de botones
                                                <div class="btn-actions-pane-right">
                                        ...
                                        <div class="mb-3 card">
                                            <div class="card-header-tab card-header">
                                                <div class="card-header-title">
													<i class="header-icon fas fa-biking"></i>
                                                   Cabecera alternativa de pestañas
												 </div>
                                                <ul class="nav">
                                            ...
                                            <div class="d-block text-right card-footer">
                                                <a href="javascript:void(0);" class="btn-wide btn-shadow btn btn-danger">Eliminar</a>
                                            </div>
                                        </div>
                                        <div class="main-card mb-3 card">
                                            <div class="card-header"><i class="header-icon fas fa-book-reader"></i>Cabecera estándar de pestañas con botones
                                                <div class="btn-actions-pane-right">
                                                    <div class="nav">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3 card">
                                            <div class="card-header-tab card-header-tab-animation card-header">
                                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="header-icon fas fa-bullhorn"></i>Alternativa con animación</div>
                                                <ul class="nav">
                                            ...
                                            <div class="d-block text-center card-footer">
                                                <a href="javascript:void(0);" class="btn-wide btn btn-link">Enlace</a>
                                                <a href="javascript:void(0);" class="btn-wide btn-shadow btn btn-danger">Eliminar</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane tabs-animation fade" id="tab-content-2" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Básico</h5>
                                        ...
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Alineación justificada</h5>
                                        ...
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Variación de pestaña</h5>
                                                <div class="mb-3">
                                                    <div role="group" class="btn-group-sm nav btn-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Grupo de botones</h5>
