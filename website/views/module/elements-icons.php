<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Íconos
                                        <div class="page-title-subheading">Simple, universal y de fácil reconocimiento. Evitar el exceso de detalles y la “sobreilustración”..
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation show active fade" id="tab-content-1" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Gradient Icons</h5>
                                                ...
                                                <div class="font-icon-wrapper font-icon-lg"><i class="fa fa-desktop icon-gradient bg-grow-early"> </i></div>
